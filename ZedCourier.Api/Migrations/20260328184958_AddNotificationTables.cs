        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_NotificationLogs_Parcels_ParcelId",
                        column: x => x.ParcelId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NotifyOnCreation = table.Column<bool>(type: "boolean", nullable: false),
                    NotifyOnStatusChange = table.Column<bool>(type: "boolean", nullable: false),
                    NotifyOnCollection = table.Column<bool>(type: "boolean", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_NotificationLogs_ParcelId",
                table: "NotificationLogs",
                column: "ParcelId");
