...
export default function OverviewTab() {
  ...
  useEffect(() => {
    Promise.all([
      fetch('https://zedcourier-1.onrender.com/api/v1/finance/summary', { headers: { Authorization: `Bearer ${token()}` } }).then(r => r.json()),
      fetch('https://zedcourier-1.onrender.com/api/v1/parcel',          { headers: { Authorization: `Bearer ${token()}` } }).then(r => r.json()),
